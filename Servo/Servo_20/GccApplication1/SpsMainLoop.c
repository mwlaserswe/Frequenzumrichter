...
void InitSPS (void)
{
	...
	//    WGM13,WGM12,WGM10,WGM11,WGM10 = 0,1,1,1    heiﬂt Fast PWM 10-Bit
	//    COM1A1,COM1A0 = 1,0  heiﬂt Clear OC1A on compare match, set OC1A at BOTTOM (Non-inverting mode)
	//    CS12,CS11,CS10 = 1,0,0      heiﬂt clk/256 (From prescaler)
	//    Mode 7: Beschreibung: ATmega328_p data sheet.pdf Seite -176-
	...
	// DDRB |= (1 << PINB3);	==> managed by Watchdog
...
/*
	...
	// Port  PB3(OC0B) as Output	-> Servo 1
	// DDRD |= (1 << PIND6);	==> managed by Watchdog
*/
